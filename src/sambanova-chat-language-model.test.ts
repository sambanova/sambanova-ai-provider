...
describe('doStream', () => {
  ...
  it('should not duplicate tool calls when there is an additional empty chunk after the tool call has been completed', async () => {
    server.responseChunks = [
      `data: {"id":"chat-2267f7e2910a4254bac0650ba74cfc1c","object":"chat.completion.chunk","created":1733162241,` +
        `"model":"meta/llama-3.1-70b-instruct:fp8","choices":[{"index":0,"delta":{"role":"assistant","content":""},"logprobs":null,"finish_reason":null}],` +
        `"usage":{"prompt_tokens":226,"total_tokens":226,"completion_tokens":0}}\n\n`,
      `data: {"id":"chat-2267f7e2910a4254bac0650ba74cfc1c","object":"chat.completion.chunk","created":1733162241,` +
        `"model":"meta/llama-3.1-70b-instruct:fp8","choices":[{"index":0,"delta":{"tool_calls":[{"id":"chatcmpl-tool-b3b307239370432d9910d4b79b4dbbaa",` +
      ...
      `data: {"id":"chat-2267f7e2910a4254bac0650ba74cfc1c","object":"chat.completion.chunk","created":1733162241,` +
        `"model":"meta/llama-3.1-70b-instruct:fp8","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,` +
      ...
      `data: {"id":"chat-2267f7e2910a4254bac0650ba74cfc1c","object":"chat.completion.chunk","created":1733162241,` +
        `"model":"meta/llama-3.1-70b-instruct:fp8","choices":[],` +
        `"usage":{"prompt_tokens":226,"total_tokens":246,"completion_tokens":20}}\n\n`,
      `data: [DONE]\n\n`,
    ];
    ...
    expect(await convertReadableStreamToArray(stream)).toStrictEqual([
      {
        ...
        modelId: 'meta/llama-3.1-70b-instruct:fp8',
  ...
  it('should pass headers', async () => {
    ...
    const customProvider = createSambaNova({
      apiKey: 'test-api-key',
      headers: {
        'Custom-Provider-Header': 'provider-header-value',
      },
    ...
    const customModel = customProvider(modelName);
  ...
  it('should send request body', async () => {
    ...
    expect(request).toStrictEqual({
      body: `{"model":"${modelName}","messages":[{"role":"user","content":"Hello"}],"stream":true,\"stream_options\":{\"include_usage\":true}}`,
    });
  });
});
